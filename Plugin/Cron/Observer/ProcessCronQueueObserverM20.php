 ...
 * @version 1.0.1
 */
class ProcessCronQueueObserverM20 extends \Magento\Cron\Observer\ProcessCronQueueObserver
{
    ...
    {
        parent::__construct($objectManager, $scheduleFactory, $cache, $config, $scopeConfig, $request, $shell, $timezone);
